# everything same from the previous number_guessing_game
#  twist is guess range is 1-1000
#project is: Number Guessing Game 
"""
steps:
first: I need to generate random number from 1 to 1000
...
def main():
    ...
    try:
        user = int(input("Enter your guess(1-1000): "))
    except ValueError:
